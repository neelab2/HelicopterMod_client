class ActionEnableAutopilotHeliCB : ActionContinuousBaseCB
{
...
class ActionHeliEnableAutopilotSIB: ActionContinuousBase
{
	void ActionHeliEnableAutopilotSIB()
	{
		m_CallbackClass = ActionEnableAutopilotHeliCB;
